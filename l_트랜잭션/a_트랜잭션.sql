...
#		- 실패가 없으면 자동 저장됨 
# > 0: 자동 커밋 비활성화 된 상태
#		- 트랜잭션 START TRANSACTION 또는 DML 문으로 시작 
