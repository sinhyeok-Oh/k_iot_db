...
CREATE DATABASE example1; -- 문장과 문장 사이; 권장
CREATE DATABASE example2;
-- CREATE DATABASE example3 -- 다음 문장이 있는 경우 필수!

CREATE DATABASE example2;-- Can't create database 'example2'; database exist
# 데이터베이스 이름은 중복될 수 없음
# >> 같은 이름의 DB 두번 생성 불가
 ...
 CREATE TABLE `school`.`student` (
    ...
    student_gender char(8) -- 학생 성별 (문자, 최대8자리)
);
...
#0	8	14:33:19	CREATE TABLE `student_encoding` (
