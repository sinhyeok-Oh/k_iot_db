...
insert into `integer`
value (127, 32767, 2000000000000,90000000000000000000000000);

-- insert into `integer`
-- value (128, 32767, 2000000000000,90000000000000000000000000);
# 해당 데이터 타입의 범위를 벗어나는 경우 발생

# cf) unisigned: 부호가 없는 정수
...
/*
	...
	cf) char: character 문자열
		varchar: vatiable character field 가변 길이 문자열
        
	1) char(개수)
    : 고정 길이 문자열, 1 ~ 255 바이트
    - 킬이가 항상 일정하기 때문에 검색 속도가 빠름
    ...
    2) varchar(개수)
     ...
     - 영어: 1바이트에 1개의 알파벳
		char(3): KOR
	 - 한글: utf-8 인코딩 기분 한 글자당 약 3바이트를 사용
...
create table `character` (
    ...
    descerption text,  -- 제품 설명(대용량 텍스트)
...
insert into product
value (12345.67, 123456.7890, 9999999999999.99);

/*
	4. 논리형
    : boolean 값을 저자하기 위한 데이터 타입
