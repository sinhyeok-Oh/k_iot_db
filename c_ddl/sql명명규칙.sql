...
/*
    ...
    3. 문자 제한]
    : 문자, 숫자, _만 사용 가능 (공백이나, 기타 특수 기호 사용 X)
...
#	- 실제 데이터임을 명시!
SELECT `price` FROM `rodects`; -- 가격 컬럼이 아니라 실제 price 문자열(글자)로 인식  
